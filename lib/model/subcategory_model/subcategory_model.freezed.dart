...
class _$SubCategoryModelTearOff {
  ...
  _SubCategoryModel call({int? id, String? label, String? name}) {
...
class _$_SubCategoryModel implements _SubCategoryModel {
  _$_SubCategoryModel({this.id, this.label, this.name});
  ...
  @override
  String toString() {
    return 'SubCategoryModel(id: $id, label: $label, name: $name)';
  }
...
abstract class _SubCategoryModel implements SubCategoryModel {
  factory _SubCategoryModel({int? id, String? label, String? name}) =
      _$_SubCategoryModel;
